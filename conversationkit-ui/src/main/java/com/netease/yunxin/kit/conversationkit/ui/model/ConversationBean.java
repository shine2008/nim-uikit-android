...
public class ConversationBean extends BaseBean {
  ...
  public ConversationBean(V2NIMConversation data, String router, int viewType) {
  ...
  public ConversationBean(
      V2NIMConversation data, String router, int viewType, String paramKey, Object paramValue) {
    infoData = data;
    this.router = router;
