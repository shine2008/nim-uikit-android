...
public class FunChatBotSubSessionChatFragment extends FunChatP2PFragment {

  private static final String TAG = "FunChatBotSubSessionChatFragment";
  ...
  public void showMessageScrollToBottom(boolean isShow) {
    ...
    if (isShow && !chatView.isMultiSelect()) {
      ...
      botSubSessionBinding.messageTipsLayout.setBackgroundResource(
          R.drawable.fun_bg_shape_circle_radius);
  ...
  private ChatBotSubSessionViewModel getSubSessionViewModel() {
