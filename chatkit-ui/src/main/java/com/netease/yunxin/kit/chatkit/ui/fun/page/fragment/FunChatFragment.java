...
public abstract class FunChatFragment extends ChatBaseFragment {
  ...
  private static final String TAG = "FunChatFragment";
  ...
  public void showMessageScrollToBottom(boolean isShow) {
    if (isShow && !chatView.isMultiSelect()) {
      ...
      if (lastMessageList.size() > 0) {
        ...
        viewBinding.messageTipsLayout.setBackgroundResource(R.drawable.fun_bg_shape_left_radius);
        ...
        viewBinding.messageTipsLayout.setBackgroundResource(R.drawable.fun_bg_shape_circle_radius);
        FrameLayout.LayoutParams layoutParams =
            (FrameLayout.LayoutParams) viewBinding.messageTipsLayout.getLayoutParams();
