...
import com.netease.yunxin.kit.conversationkit.local.ui.page.interfaces.IConversationCallback;
 ...
 */
public abstract class LocalConversationBaseFragment extends BaseFragment implements ILoadListener {
  ...
  protected ILocalConversationFactory conversationFactory;
  // 会话列表封装View
        ...
        if (LocalConversationKitClient.getConversationUIConfig() != null
          ...
          result =
              LocalConversationKitClient.getConversationUIConfig()
                  .itemClickListener
                  .onClick(
                      LocalConversationBaseFragment.this.getContext(),
